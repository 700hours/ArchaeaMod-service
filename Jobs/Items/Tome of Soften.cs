public void UseItem(Player player, int playerID)
{
	...
	for(int m = 0; m < npc.Length-1; m++)
	{
		...
		item.toolTip2 = "Costs "+(nPC.width/4)+" mana"; 
		...
		if(mouse.Intersects(npcBox) && player.statMana >= nPC.width/4 && Main.mouseState.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && Main.oldMouseState.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Released)
		{
			player.statMana -= nPC.width/4;
