...
namespace ArchaeaMod.Buffs
{
    public class mercury : ModBuff
    {
        ...
        public override void Update(NPC npc, ref int buffIndex)
        {
            ...
            Dust.NewDust(npc.position, npc.width, npc.height, ModContent.DustType<Merged.Dusts.c_silver_dust>());
        }
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            Dust.NewDust(player.position, player.width, player.height, ModContent.DustType<Merged.Dusts.c_silver_dust>());
        }
    }
}
